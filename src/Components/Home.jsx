    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-12 col-xl-6 m-0 p-0 custom z-2 d-grid order-1 order-xl-0 " > <span className='stats'><Countup enableScrollSpy={true} start={0} end={240} duration={4}   >  </Countup> + <br /> CUSTOMERS </span>   </div>
         ...
         <div className="col-12 col-xl-6 m-0 p-0 custom z-2 d-grid order-2 order-xl-2 " >  <motion.div initial={{ opacity: 0,y:30} }whileInView={{ opacity: 1,y:0 }}transition={{ duration: 1 }} useelementscroll="true" className='d-grid z-3' >  <img src={require('../assets/rishi.jpg')} alt="" className='image' /> </motion.div>    </div>
