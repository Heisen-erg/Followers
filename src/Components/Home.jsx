  ...
  return (
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-12 col-xl-6 m-0 p-0 custom z-2 d-grid"><motion.div initial={{ opacity: 0,y:10} }whileInView={{ opacity: 1,y:0 }}transition={{ duration: 1 }} useelementscroll='true' className='d-grid z-3' >   <img fetchpriority="high"  src= {require("../assets/instgram.png")} alt="" className='image' /> </motion.div>   </div>
